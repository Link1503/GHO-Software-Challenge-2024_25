            ...
            if(Gespielte_Schleife != "nichts" ){
                ...
                while (Nächter_Igel < Nächstes_Feld ||
                	    ...
                	    if (typ != null && nächstesFeld != null) {
                	        ...
                	        if (next != null) {
                	            switch (typ) {
                	                case HEDGEHOG: Nächter_Igel = next; break;
                	                case HARE: Nächter_Hase = next; break;
                	                case SALAD: Nächter_Salat = next; break;
                	            }
                	        } else {
                	            switch (typ) {
                	                case HEDGEHOG: Nächter_Igel = 65; break;
                	                case HARE: Nächter_Hase = 65; break;
                	                case SALAD: Nächter_Salat = 65; break;
                	            }
                	        }
                	    }
                	}
