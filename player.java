...
public class Logic implements IGameHandler {
  ...
  public Move calculateMove() {                                             
	  ...
	  long startTime = System.currentTimeMillis();                                          // zum messen der Zeit 
         ...
         if(Gespielte_Schleife != "nichts" ){
            ...
            while (Nächter_Igel < Nächstes_Feld  || 
            	   Nächter_Hase < Nächstes_Feld  && Kartenspielbarkeit == false && Nächstes_Feld != Nächter_Hase || 
                ...
                if (Nächter_Igel < Nächstes_Feld ) {
                        ...
                        if ( gameState.getBoard().getNextField(Field.HEDGEHOG, Nächter_Igel) != null ) {
                ...
                if  (Nächter_Hase < Nächstes_Feld  && Kartenspielbarkeit == false && Nächstes_Feld != Nächter_Hase) {
                        ...
                        if ( gameState.getBoard().getNextField(Field.HARE, Nächter_Hase) != null ) {
                ...
                if (Nächter_Salat < Nächstes_Feld  && Eigne_Salate == 0 && Nächstes_Feld !=  Nächter_Salat && Eigne_Position != Nächter_Salat) {

	                    Nicht_begebare_Felder = Nicht_begebare_Felder + 1;
	                    
	                    if ( gameState.getBoard().getNextField(Field.SALAD, Nächter_Salat) != null ) {
    ...
    System.out.println("Nächster Markt: " + Nächter_Markt);
    System.out.println("Mögliche Züge: " + Mögliche_Züge + "   " + Anzahl_Mögliche_Züge + "\n");
    ...
    System.out.println("Gespielte Schleife: \u001B[31m" + Gespielte_Schleife + "\u001B[0m");
    System.out.println( Kartenspielbarkeit);
